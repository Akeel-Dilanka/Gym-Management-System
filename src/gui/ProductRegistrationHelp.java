 ...
 * @author User
 */
public class ProductRegistrationHelp extends javax.swing.JFrame {

    GRN grn;
    /**
     * Creates new form h
     */
    public ProductRegistrationHelp() {
        initComponents();
        loadBrands();
        loadCategories();
        loadProducts();
    ...
    public ProductRegistrationHelp(GRN grn) {
        initComponents();
        loadBrands();
        loadCategories();
        loadProducts();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 900));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                String pbrand = jTable1.getValueAt(r, 2).toString();
                String pcategory = jTable1.getValueAt(r, 3).toString();
         
                grn.jLabel10.setText(pid);
                grn.jLabel13.setText(pname);
                grn.jLabel16.setText(pbrand);
                grn.jLabel18.setText(pcategory);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductRegistrationHelp().setVisible(true);
            }
        });
    }
