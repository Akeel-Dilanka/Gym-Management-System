...
public class Workout extends javax.swing.JFrame {
    ...
    public Workout(WorkoutHandout wh) {
        initComponents();
        ImageIcon icon = new ImageIcon("src/resources/icon_img.jpg");
        Image img = icon.getImage();
        setIconImage(img);
    ...
    public void loadWorkout() {
        ...
        try {
            ...
            ResultSet rs = MySQL.search("SELECT * FROM `workout` ORDER BY `workout`.id ASC");
    ...
    public void loadWorkout(String text) {

        try {

            ResultSet rs = MySQL.search("SELECT * FROM `workout` WHERE `workout`.`name` LIKE '" + text + "%' ORDER BY `workout`.id ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 100, 120, 32));
        ...
        jButton2.setText("Create New Workout");
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 260, 60, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter Workout name", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {

            try {

                MySQL.iud("INSERT INTO `workout`(`name`) VALUES ('" + name + "')");

                jTextField1.setText("");
                loadWorkout();
                jTextField1.grabFocus();

                JOptionPane.showMessageDialog(this, "New Workout created", "Success", JOptionPane.WARNING_MESSAGE);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                JOptionPane.showMessageDialog(this, "Please select a workout", "Warning", JOptionPane.WARNING_MESSAGE);
            } else {
                String cname = jTable1.getValueAt(r, 1).toString();

                wh.jLabel25.setText(cname);
